...
export default function ContactPage() {
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', minHeight: '100vh', backgroundColor: '#000' }}>
      <DarkVeil />
      <div style={{
        position: 'fixed',
        top: '5px',
      ...
      <section className="bg-black relative w-full overflow-hidden py-16 md:py-24">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          <div className="border-white/40 bg-black/20 mx-auto max-w-5xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
            <div className="grid md:grid-cols-2">
              <div className="relative p-6 md:p-10" ref={formRef}>
                ...
                >
                  <h2 className="from-white to-white/80 mb-2 bg-gradient-to-r bg-clip-text text-4xl font-bold tracking-tight text-transparent md:text-5xl">
                    Contact
                  </h2>
              ...
              >
                <div className="flex flex-col items-center justify-center overflow-hidden">
                  <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#e60a64] to-[#e60a64]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                    Send Mail message or contact to Dr. Asghar
                  </article>
                </div>
              </motion.div>
            </div>
